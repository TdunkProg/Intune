...
# Pin Chrome and Office Apps to taskbar
...
Pin-ToTaskbar -targetfile "$StartMenuFolder\Excel.lnk" -Action pin
Pin-ToTaskbar -targetfile "$StartMenuFolder\Word.lnk" -Action pin
Pin-ToTaskbar -targetfile "$StartMenuFolder\Outlook.lnk" -Action pin
